...
>(({ className, showValue, ...props }, ref) => (
  ...
  >
    ...
    <RadixSlider.Thumb className="block size-5 cursor-grab rounded-full border-2 border-primary bg-background shadow-md ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 active:cursor-grabbing disabled:pointer-events-none disabled:opacity-50" />
  </RadixSlider.Root>
))
